...
func mockFetch(rows ...ResourceDataRaw) func(ctx context.Context, d *schema.ResourceData, meta any) ([]ResourceDataRaw, error) {
	return func(_ context.Context, _ *schema.ResourceData, _ any) ([]ResourceDataRaw, error) {
		return rows, nil
	}
}
