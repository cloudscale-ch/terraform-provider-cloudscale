...
* `addresses` - (Optional) A list of address blocks that assign IP addresses to the interface. If
  ...
  * `address` - (Optional) A specific IP address to assign. If omitted, an address from the subnet
